      ...
      <div className="flex-1">
        <div className="bg-slate-50 p-10 rounded-xl border border-slate-200">
          ...
          <p className="text-2xl font-light text-foreground italic mb-8">
                supply chain leader with more tham 15 years of experience in Product and Process design , improvement and management
          </p>
          <div>
            <p className="font-semibold text-foreground text-lg">Mahesh Hedge</p>
            <p className="text-slate-600">Head of Business - Unified Fulfilment Platform</p>
          </div>
        </div>
      </div>
    </div>
