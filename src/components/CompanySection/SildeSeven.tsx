      ...
      <div className="flex-1">
        <div className="bg-slate-50 p-10 rounded-xl border border-slate-200">
          ...
          <p className="text-2xl font-light text-foreground italic mb-8">
                An achievement-orirented professional with over 20 years of rich experience in eCommerce fulfillment services and operations excellence
          </p>
          <div>
            <p className="font-semibold text-foreground text-lg">Nitesh Sahay</p>
            <p className="text-slate-600">VP - Business</p>
          </div>
        </div>
      </div>
    </div>
