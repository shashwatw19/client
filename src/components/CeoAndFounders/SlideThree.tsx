      ...
      <div className="flex-1">
        <div className="bg-slate-50 p-10 rounded-xl border border-slate-200">
          ...
          <p className="text-2xl font-light text-foreground italic mb-8">
            naicos is the engine of agentic commerce - empowering brands to sell, scale, and self- optimize across every
            digital channel with native AI. It's not just software - it's a self-evolving commerce brain!
          </p>
          <div>
            <p className="font-semibold text-foreground text-lg">Vineet Agarwal</p>
