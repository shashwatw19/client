      ...
      <div className="flex-1">
        <div className="bg-slate-50 p-10 rounded-xl border border-slate-200">
          ...
          <p className="text-2xl font-light text-foreground italic mb-8">
            Technology transforms lives when it's built with empathy and a clear understanding of the end-user needs.
            naicos profoundly embodies this philosophy. We are building for everyone - from large retailers to
            small-town sellers.
          </p>
          <div>
            <p className="font-semibold text-foreground text-lg">Surbhi Sinha</p>
            <p className="text-slate-600">CO-Founder & CAO</p>
          </div>
        </div>
      </div>
    </div>
