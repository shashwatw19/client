...
const pricingProps : FeatureDescriptionType = {
    id : "pricing",
    title : "pricing",
    description : ["Price Comparator for Similar Products" , "Product + Platform Specific Price Recommendation" , "Customer Ratings & Product Insights for Top Sellers"],
    imgSrc : pricingScreen,
    aligned : "left"
}
const catalogProps : FeatureDescriptionType = {
    id : "catalog",
    title : "catalog",
    description : ["Pre-Configured Yet Flexible Product Management (PIM)" , "AI Generated Images and SEO Optimized Content in Minutes" , "Catalog Syndication for Different Platforms"],
    imgSrc : catalogScreen,
    aligned : "right"
}
const fulfilmentProps : FeatureDescriptionType = {
    id : "fulfilment",
    title : "fulfilment",
    description : ["Connected to All Marketplaces & Storefronts" , "PreIntegrated With All National Logistics Players (B2B/B2C)" , "Smart AI Agents for Order Verification & NDR Management"],
    imgSrc : fulfilmentScreen,
    aligned : "right"
}
const growthProps : FeatureDescriptionType = {
    id : "growth",
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <h1 className="uppercase   w-full text-center text-6xl font-extrabold text-black mt-30 mb-20">
        A <span className="text-[#38b6ff]">Native</span> AI powered platform
      </h1>
      ...
      <FeatureDescription title={catalogProps.title} description={catalogProps.description} imgSrc={catalogProps.imgSrc}  aligned={catalogProps.aligned} id={catalogProps.id}/>  
      <FeatureDescription title={pricingProps.title} description={pricingProps.description} imgSrc={pricingProps.imgSrc}  aligned={pricingProps.aligned} id={pricingProps.id}/> 
      <FeatureDescription title={fulfilmentProps.title} description={fulfilmentProps.description} imgSrc={fulfilmentProps.imgSrc}  aligned={fulfilmentProps.aligned} id={fulfilmentProps.id}/>
      <FeatureDescription title={growthProps.title} description={growthProps.description} imgSrc={growthProps.imgSrc}  aligned={growthProps.aligned} id={growthProps.id}/>         
